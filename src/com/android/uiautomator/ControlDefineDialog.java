 ...
 *
 * "OK" button won't be enabled unless both files are selected It also has a
 * convenience feature such that if one file has been picked, and the other file
 * path is empty, then selection for the other file will start from the same
 * base folder
 *
 */
